  ...
  return (
    <div style={{ 
      ...
      <div style={{ maxWidth: '500px', margin: '0 auto' }}>
        ...
        <p style={{ opacity: 0.7, marginBottom: '20px', fontSize: '14px' }}>Enter product. Result <b>Telegram</b> + Dashboard par aayega.</p>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          >
            {loading ? '⏳ Processing...' : '🔥 Kill Ads & Send to Mobile'}
          </button>
        </div>
        ...
        {campaignId && (
          <div style={{ marginTop: '20px', padding: '16px', background: dark ? '#222' : '#e0f2fe', borderRadius: '16px' }}>
            ...
            <p style={{ fontSize: '12px', opacity: 0.6 }}>Telegram check karein! Preview aagaya hoga.</p>
          </div>
        )}
